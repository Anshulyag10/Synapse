"""Custom exception hierarchy for EvidenceGraph.
...
class EvidenceGraphError(Exception):
    """Base for all EvidenceGraph exceptions."""


# ── Retrieval ──────────────────────────────────────────────────────────

class RetrievalError(EvidenceGraphError):
...
class IngestionError(EvidenceGraphError):
...
class AgentError(EvidenceGraphError):
...
class GroundingError(EvidenceGraphError):
...
class ConfigurationError(EvidenceGraphError):
